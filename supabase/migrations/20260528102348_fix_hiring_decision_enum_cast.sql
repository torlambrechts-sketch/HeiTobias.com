-- requisition_candidates.decision is requisition_candidate_decision enum;
-- hiring_decisions.decision is hiring_decision enum. They share labels
-- but are distinct types — direct assignment fails with 42804. Cast
-- through text when mirroring.
